...
Interview the user until `docs/seo/<domain>/strategy.md` and `glossary.md` hold everything `seo-content` needs to write a page without asking. Needs the workspace from `seo-setup`; missing: run that first.
