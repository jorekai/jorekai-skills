...
## Competitors (needs Offer, Audience) → "Competitors"
...
## Keywords (needs Offer, Audience, Competitors) → "Keyword clusters"
...
## Evidence (needs Keywords) → "Evidence inventory"
...
## Vocabulary (every round) → `glossary.md`
...
## Open questions (close) → "Open questions"
