...
1. **Run the status script.**
   ...
   Path relative to this skill's directory. Without a domain it reports every folder under `docs/seo/`. Exit code 2 means no workspace: the answer is `seo-setup`, stop here.
...
2. **Correct the list with what the files cannot show.** Three cases, nothing else:
   - The user reports a drop in clicks, impressions, or position: `seo-diagnose` goes to the top of the list, before any content step.
