...
Read before running any `jorekai-seo:*` skill on this domain. One `key: value` per line so agents and scripts can parse it. Unknown stays blank; a guess is worse than a blank.
